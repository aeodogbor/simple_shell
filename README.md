<p align="center">
  <img src="http://www.alxafricaschool.com/alxafrica-logo.png" alt="Alxafrica School logo">
</p>
...
/home/vagrant/alxafrica/simple_shell
```
...
/home/vagrant/alxafrica/bog-062019-test_suite
```
...
Example:
```
$ echo "echo 'alxafrica' #this will be ignored!" | ./sodash
'alxafrica'
```
...
Example:
```
$ echo "error! && echo 'alxafrica'" | ./sodash
./shellby: 1: error!: not found
$ echo "echo 'my name is' && echo 'alxafrica'" | ./sodash
'my name is'
'alxafrica'
```
...
**Sodash** is a simple shell unix command interpreter that is part of the alxafrica low level programming module at Alxafrica School and is intended to emulate the basics **sh** shell. All the information given in this README is based on the **sodash** and **bash** man (1) pages.
